...
/*!
    ...
    \param[in]  gpio_remap: select the pin to remap
      ...
      \arg        GPIO_TIMER1ITR0_REMAP: TIMER1 internal trigger 0 remapping(only for GD32F10X_CL devices) 

...
/*!
    ...
    \param[in]  dma: timer DMA source enable 
      \arg        TIMER_DMA_UPD:  update DMA enable,TIMERx(x=0,2,3,5..7)
      \arg        TIMER_DMA_CH0D: channel 0 DMA enable,TIMERx(x=0,2,3,7)
      \arg        TIMER_DMA_CH1D: channel 1 DMA enable,TIMERx(x=0,2,3,7)
      \arg        TIMER_DMA_CH2D: channel 2 DMA enable,TIMERx(x=0,2,3,7)
      \arg        TIMER_DMA_CH3D: channel 3 DMA enable,TIMERx(x=0,2,3,7)
      \arg        TIMER_DMA_CMTD: commutation DMA request enable,TIMERx(x=0,7)
      \arg        TIMER_DMA_TRGD: trigger DMA enable,TIMERx(x=0,2,3,7)
    \param[out] none
    \retval     none
*/
...
/*!
    ...
    \param[in]  timer_periph: TIMERx(x=0,2,13,14,15,16)
    \param[in]  ccsel: 
